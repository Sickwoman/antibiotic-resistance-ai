...
**Status: Version 0.3 – baseline models (logistic regression, random forest, LightGBM) trained and
evaluated on in-hospital test data.** Versions 0.1 (download + exploration) and 0.2 (preprocessing,
dataset, splits) are complete. Models are evaluated as fixed in
[`docs/evaluation_protocol.md`](docs/evaluation_protocol.md), approved before any model was trained.
